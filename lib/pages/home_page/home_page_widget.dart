        ...
        drawer: Drawer(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(30.0, 40.0, 30.0, 8.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Align(
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(30.0, 20.0, 30.0, 8.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Align(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '2llpi0hc' /* Introduction to Psychology */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                        ...
                        child: Row(
                          ...
                          children: [
                            Align(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'aymih2y6' /* Courses you haven't viewed */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(8.0),
                                  child: SvgPicture.asset(
                                    'assets/images/undraw_brainstorming_re_1lmw.svg',
                                    width: 87.0,
                                    height: 223.0,
                                    fit: BoxFit.cover,
                                  ),
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'jzg70q40' /* How to prepare for GMAT */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'wzvesdkj' /* Introduction to Psychology */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
